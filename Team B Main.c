...
#pragma config(Motor,  port1,           plateMotor,    tmotorNone, openLoop)
#pragma config(Motor,  port2,           leftBack,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           leftMiddle,    tmotorVex393_MC29, openLoop, reversed)
