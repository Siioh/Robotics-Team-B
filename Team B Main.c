...
void joystickControl() { //Joystick control for drivetrain
	motor[rightFront] = rotationCalculate(vexRT[rightDrivetrainCtrl] / userSpeedFactor);
	motor[rightBack] = rotationCalculate(vexRT[rightDrivetrainCtrl] / userSpeedFactor);
	motor[leftFront] = rotationCalculate(vexRT[leftDrivetrainCtrl] / userSpeedFactor);
	motor[leftBack] = rotationCalculate(vexRT[leftDrivetrainCtrl] / userSpeedFactor);
}
